package com.framework.admin.core.conf;

import com.framework.admin.core.alarm.JobAlarmer;
...
import com.framework.admin.dao.XxlJobRegistryDao;
...
public class XxlJobAdminConfig implements InitializingBean, DisposableBean {
  ...
  // application启动后执行该方法  生命周期中的属性注入来对xxlJobScheduler初始化
  @Override
